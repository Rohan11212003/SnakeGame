...
//     function createFood() {
//         let shapes = ['circle', 'square']; // Array of food shapes
//         let randomShape = shapes[Math.floor(Math.random() * shapes.length)]; // Randomly choose a shape
  
//         // Set food coordinates and shape
//         food = {
...
//     function moveSnake() {
//         let head = { x: snake[0].x, y: snake[0].y }; // Get the head of the snake
...
//         alert(`Game Over! Your score is ${score}`); // Show game over alert
//     }
// });
document.addEventListener("DOMContentLoaded", function () {
    // Initialize variables
